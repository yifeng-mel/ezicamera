...
@section('content')
  <div class="overlay d-none">
      <div class="overlay-center bg-white" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); width: 400px; height: 260px; border-radius:15px">
          <div class="overlay-inside-div-center downloading d-none">
                    ...
                    <tbody>
                      @foreach($files_arr as $file)
                        <tr>
                          ...
                          <td>{{$file['duration']}}</td>
                          <td>{{$file['size']}}</td>
                          <td><button class="btn btn-link p-0" role="link" data-filename-value="{{$file['filename']}}" data-byte-size-value="{{$file['byte_size']}}">download</button></td>
                        </tr>
                      @endforeach                                                                                                                               
                    </tbody>
                  </table>
